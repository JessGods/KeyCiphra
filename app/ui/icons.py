...
_ICON_NODES = {
    ...
    "folder-plus": (
        '<path d="M12 10H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-6z"/>'
        '<path d="M2 10V6a2 2 0 0 1 2-2h5l3 3h6a2 2 0 0 1 2 2v3"/>'
        '<path d="M12 15v4"/><path d="M10 17h4"/>'
    ),
    "lock": (
    ...
    "tags": (
        '<path d="M13.172 2H4a2 2 0 0 0-2 2v9.172a2 2 0 0 0 .586 1.414l7.71 7.71a2.426 2.426 0 0 0 3.42 0l8.58-8.58a2.426 2.426 0 0 0 0-3.42l-7.71-7.71A2 2 0 0 0 13.172 2"/>'
        '<circle cx="7.5" cy="7.5" r=".5" fill="currentColor"/>'
        '<path d="m15 5 6 6"/>'
    ),
    "trash": (
